...
import { cardDelete , cardSetPriority , cardEdit} from '../../state-management/actions/cardAction';
...
const priorityColor = {
    ...
    return (
        <section className="cards">
            {cards.map((item) =>
                <div className={item.index == index ? `card ${isDark ? 'dark-list' : null}` : "d-none"} style={{borderRight:`3px solid ${priorityColor[item.priority]}`}}>
